...
object io {
  val lines = Source.fromFile("/home/junius/git_hub/scala/oneScala/src/main/scala/org/oneScala/one.scala").getLines
                                                  //> lines  : Iterator[String] = non-empty iterator
  lines.foreach(println)                          //> package main.scala.org.oneScala
                                                  //| 
                                                  ...
                                                  //|       //val itr1: scala.collection.immutable.Iterable[Int] = new LinkedList[
                                                  //| Int]()
